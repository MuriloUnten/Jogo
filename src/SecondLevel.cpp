...
#define GROUND3_PATH "../assets/mundo/ground_tile.png" 
#define GROUND2_PATH "../assets/mundo/ground2_tile.png"


namespace Levels
{
    SecondLevel::SecondLevel(std::string fileName, sf::Vector2f size, sf::Vector2f position, Entities::MovingEntities::Player* player):
